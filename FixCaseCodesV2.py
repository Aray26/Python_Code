...
excel_df = pd.read_excel('Uncased Items2.xlsx', sheet_name='Case')
...
print "Number of files " + str(len(listy2)) + "\n"
...
for file in listy2:
    ...
    print "NUMBER OF FILES " + str(number_of_files_read) + "\n"
    ...
    print length_of_rows_in_file
    length_of_rows = int(length_of_rows)
